...
import 'norton-theorem-data.dart';

class NortonTheoremScreen extends StatefulWidget {
  const NortonTheoremScreen({Key? key}) : super(key: key);

  @override
  _NortonTheoremScreenState createState() => _NortonTheoremScreenState();
}

class _NortonTheoremScreenState extends State<NortonTheoremScreen> {
  SizedBox zero() {
          ...
          onChanged: switchOn
              ? (dynamic values) {
                  setState(() {
                    ...
                    iNorton = vSupply / r1;
                    rNorton = (r1 * r2) / (r1 + r2);
                    iLoad = ((rNorton * iNorton) / (rNorton + r3));
                  });
                }
              : null,
          value: switchOn ? r3 : 0,
                        ...
                        children: [
                          ...
                          theoryIndex == 0
                              ? Column(
                                  children: [
                                    Column(
                                      children: nortonProcedure.map((strone) {
                                        return Row(children: [
                                          Text(
                                            "\u2022",
                                            style: TextStyle(
                        ...
                        Stack(
                          children: [
                            Padding(
                              ...
                              child: Container(
                                  ...
                                  child: CircularMeter(
                                    ...
                                    meterName: "RL",
                                    value: switchOn ? roundDouble(r3, 0) : 0.0,
                                    range1: 800,
                                    range2: 2000,
                                    firstColorCut: 1200,
                                    secondColorCut: 1600,
                            ...
                            Padding(
                                ...
                                child: switchOn
                                    ? Text(
                                        "I Norton = ${roundDouble(iNorton, 2)}")
                                    : const Text("0.0")),
                            Padding(
                                padding: EdgeInsets.only(
                                ...
                                child: switchOn
                                    ? Text(
                                        "R Norton = ${roundDouble(rNorton, 2)}")
                                    : const Text("0.0")),
                            Padding(
                                padding: EdgeInsets.only(
                                    top: size.height * 0.11,
                                    left: size.width * 0.45),
                                child: switchOn
                                    ? Text("I load = ${roundDouble(iLoad, 4)}")
                                    : const Text("0.0")),
                            // Padding(
                            //   padding: EdgeInsets.only(
                            //       left: size.width * 0.45),
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return QuizScreen(
                                      title: nortonTitle,
                                      optionOne: nortonOptionOne,
                                      optionTwo: nortonOptionTwo,
                                      optionThree: nortonOptionThree,
                                      optionFour: nortonOptionFour,
                                      questionsList: nortonQuestionsList,
                                      experimentScreen: nortonExperimentScreen,
                                      noOfQuestions: nortonNoOfQuestions,
                                      correctAnswers: nortonCorrectAnswers,
                                      quizTitle: nortonAim,
                                    );
                                  },
                                ),
